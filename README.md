...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/winkerberos-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/winkerberos-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add winkerberos
# for installing globally
pixi global install winkerberos
```
...
It is possible to list all of the versions of `winkerberos` available on your platform:
...
```
pixi search winkerberos --channel conda-forge
```
